  ...
  reviews.forEach(review=>{
    review_cont.innerHTML+=`<div class="review xl:w-[819px] w-[80vw] mt-10 md:mt-16 mx-10" >
            <div class="name-items flex w-full items-center">
              <div class="first-later font-bold h-12 w-12 text-3xl text-white bg-[#ff1f78] rounded-full flex justify-center items-center"><h2 class="font-['Poppins']">${review.name.substr(0,1).toUpperCase()}</h2></div><span class="ml-5 font-['Poppins'] font-bold text-xl">${review.name}</span>
            </div>
